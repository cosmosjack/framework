    ...
    <div class="mine_info container-fluid">
        <div class="reg_top row">
            ...
            <span class="col-xs-12 text-right">
                <span class="alter" href_url="<?php echo urlBBS('set','editInfo');?>">修改资料</span>
            </span>
        </div>
        <div class="content">
            <div class="row">
               <div class="col-xs-12 avatar">
                 <span>我的头像：</span>
                 <img src="<?php echo $output['info']['headimgurl']?$output['info']['headimgurl'].'!product-60':BBS_RESOURCE_SITE_URL.'/bootstrap/img/logo.png'?>" class="col-xs-3 pull-right" />
               </div>
            </div>
            <div class="row">
        ...
        <div class="management row overflow" href_url="<?php echo urlBBS('set','manageSelect')?>">
            <div class="col-xs-8">
