    ...
    <div class="order_paid">
    	...
    	<div class="nav overflow text-center">
    		...
    		<div class="col-xs-3" href_url="<?php echo urlBBS('order','orderPaid')?>">
    			<img src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/img/paid_s.png" class="col-xs-8 col-xs-offset-2" />
        	...
        	<div class="order_pro overflow">
        	 	<div class="col-xs-12 overflow">
        	 		...
        	 		<div class="col-xs-3 price_sum">
        	 			...
        	 			<button class="pay" href_url="../product_deta/product_deta.html">查看</button>
        	 		</div>
        	 	</div>
        	</div>
            <div class="order_pro overflow">
