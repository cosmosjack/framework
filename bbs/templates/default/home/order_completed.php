...
<body>
    <div class="order_completed">
        ...
        <!-- <div class="content container-fluid">
        	<div class="order_pro overflow" href_url="../product_deta/product_deta.html">
        	 	<div class="col-xs-12 overflow">
        	 		<div class="orpro_img col-xs-4 overflow">
        	 			<img src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/img/img2.jpg" class="col-xs-12" />
        	 		</div>
        	 		<div class="col-xs-5 order_pro_txt">
