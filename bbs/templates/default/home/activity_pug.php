...
<body>
    <div class="activity_pug">
    	...
    	<div class="pug_content overflow">
    		<div class="col-xs-12 pug" href_url="<?php echo urlBBS('mine','photo',array('activity_no'=>$output['info']['activity_no'],'activity_periods'=>$output['info']['activity_periods']))?>">
    			<div class="overflow">
    				<img src="<?php echo $output['info']['activity_index_pic']?>!product-360" class="col-xs-3" />
    				<div class="col-xs-7 pug_txt">
    					<div>活动相册</div>
    					<div class="pug_sum"><img src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/img/count.png" /><span><?php echo $output['count']?></span></div>
    				</div>
