    	...
    	<div class="top row">
    	 	<div class="overflow">
    	 	 	<div class="fl col-xs-6 row set">
	    	 	 	<img src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/img/setting.png" onclick="Href('<?php echo urlBBS('set','setUp')?>')" />
    	 	...
    	 	<div class="logo text-center container-fluid">
	    		 <img src="<?php echo $output['info']['headimgurl']?$output['info']['headimgurl']:BBS_RESOURCE_SITE_URL.'/bootstrap/img/logo.png'?>" class="img-circle" />
	    		 <h4 class="col-xs-12 test"><?php echo $output['info']['nick_name']?$output['info']['nick_name']:$output['info']['member_name'];?></h4>
	    		 <div class="grade_gender col-xs-12">
	    		    <div class="row">
		    		 	<div class="col-xs-12 text-center"><span>我的勋章 : </span><img src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/img/level<?php echo $output['level']?>.png" /></div>
	    		    </div>
    	  ...
    	  <!--成长相册-->
    		<div class="growth_record row" onclick="Href('<?php echo urlBBS('mine','album')?>')">
    		 	...
    		 	<div class="col-xs-4 txt row">
    		 		...
    		 		<div class="col-xs-12"><span class="col-xs-4"><?php echo $output['albumCount'];?></span></div>
    		 	</div>
    	  ...
    	  <!--成长记录-->
    		<div class="growth_record row" onclick="Href('<?php echo urlBBS('mine','growRecord')?>')">
    		 	...
    		 	<div class="col-xs-4 txt row">
    		 		...
    		 		<div class="col-xs-12"><span class="col-xs-4"><?php echo $output['growCount'];?></span></div>
    		 	</div>
    		 	<div class="col-xs-6 enter row">
    		 		<div class="col-xs-12 text-right">
    		 			<span class="added"></span><span class="glyphicon glyphicon-menu-right"></span>
    		...
    		<div class="growth_record row" onclick="Href('<?php echo urlBBS('mine','collect')?>')">
    		 	...
    		 	<div class="col-xs-4 txt row" >
    		 		...
    		 		<div class="col-xs-12"><span class="col-xs-4"><?php echo $output['collectCount'];?></span></div>
    		 	</div>
    		 	<div class="col-xs-6 enter row">
    		 		<div class="col-xs-12 text-right">
            ...
            <!--我的领队-->
            <?php if($output['info']['is_teacher']):?>
            <div class="growth_record row" onclick="Href('<?php echo urlBBS('mine','leader')?>')">
                <div class="col-xs-3 img">
                    <img src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/img/myleader.png" class="img-responsive" />
                </div>
                <div class="col-xs-4 txt row">
                    <span class="col-xs-12">我的领队</span>
                    <div class="col-xs-12"><span class="col-xs-4"><?php echo $output['teacherCount']?></span></div>
                </div>
                <div class="col-xs-6 enter row">
                    <div class="col-xs-12 text-right">
                        <span class="glyphicon glyphicon-menu-right"></span>
