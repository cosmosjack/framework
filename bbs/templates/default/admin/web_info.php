...
defined('InCosmos') or exit('Access Invalid!');?>
    ...
    <!-- Morris -->
    <link href="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/css/plugins/morris/morris-0.4.3.min.css" rel="stylesheet">

    <!-- Gritter -->
    <link href="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/gritter/jquery.gritter.css" rel="stylesheet">
...
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/flot/jquery.flot.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/flot/jquery.flot.tooltip.min.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/flot/jquery.flot.spline.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/flot/jquery.flot.resize.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/flot/jquery.flot.pie.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/flot/jquery.flot.symbol.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/peity/jquery.peity.min.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/demo/peity-demo.min.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/content.min.js?v=1.0.0"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/jquery-ui/jquery-ui.min.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/easypiechart/jquery.easypiechart.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/plugins/sparkline/jquery.sparkline.min.js"></script>
<script src="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/js/demo/sparkline-demo.min.js"></script>
<script>
