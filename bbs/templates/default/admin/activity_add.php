                            ...
                            <div class="col-sm-10">
                                <label>
                                    ...
                                    <a style="text-align: center">
                                        <div id="localImage">
                                            <img id="preview" src="<?php echo $output['form_data']['activity_index_pic'] ? $output['form_data']['activity_index_pic'] : BBS_RESOURCE_SITE_URL.DS."bootstrap".DS.'img/vcs.jpg';?>" style="margin:0 auto .1rem;display: block; width: 375px; height: 222px;">
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <label>
                                    ...
                                    <a style="text-align: center">
                                        <div id="localImage1">
                                            <img id="preview1" src="<?php echo $output['data_bbs_uploads'][0]['file_name'] ?$output['data_bbs_uploads'][0]['file_name'] :  BBS_RESOURCE_SITE_URL.DS."bootstrap".DS.'img/banner1.jpg';?>" style="margin:0 auto .1rem;display: block; width: 320px; height: 190px;">
                                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div>
                                    ...
                                    <?php echo $output['form_data']['activity_body']?$output['form_data']['activity_body']:$output['form_data']['activity_desc'];?>
                                    </textarea>
                                </div>
                            </div>
                        </div>
