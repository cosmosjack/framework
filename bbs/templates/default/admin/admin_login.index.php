...
------------------------------------------------------------------- */
    ...
    * html .fixedbar { width: 100%; margin-top: -10px; position: relative; left: -20px;}
    ...
    <link href="<?php echo BBS_RESOURCE_SITE_URL;?>/bootstrap/css/login.min.css" rel="stylesheet">
    <!--[if lt IE 8]>
...
<div class="signinpanel">
    <div class="row">
        <div class="col-sm-7">
            <div class="signin-info">
                ...
                <div class="m-b"></div>
                <h4>欢迎使用 <strong>好少年 后台</strong></h4>
                <ul class="m-b">
        ...
        <div class="col-sm-5">
            <form method="post" action="<?php echo BBS_SITE_URL.'/index.php';?>">
                <h4 class="no-margins">登录：</h4>
                <p class="m-t-md">登录到好少年后台</p>
                ...
                <input type="hidden" name="hashValue" value="<?php echo $output['hashValue'];?>"/>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            &copy; 2018 All Rights Reserved. 好少年
        </div>
    </div>
</div>
</body>
