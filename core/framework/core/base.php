...
//
		...
		//$setting['hao_version'] = 'Copyright 2015 <a href="http://bbs.cosmos-jack" target="_blank">bbs.cosmos-jack</a> All rights reserved.<br />本演示来源于<a href="http://33haocom.taobao.com" target="_blank">33haocom.taobao.com</a>';
...
//				exit("Class Error: {$class}.isn't exists!");
                ...
                define(VENDER,"cosmos");
                include_once(BASE_ROOT_PATH."/cosmos/autoload.php");
	...
	private static function cp(){
		...
		if (strpos(self::CPURL,'||') !== false){
			...
			header('location: http://log.shikexu.com');exit();
		}else{
