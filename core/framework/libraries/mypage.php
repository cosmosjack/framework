...
html;
		...
		private function first(){
			if($this->page > 1) {
				$str = "<li><a class='fpage_a' href='{$this->uri}page=1'>{$this->config["first"]}</a></li>";
				return $str;
			}
		...
		private function prev(){
			if($this->page > 1) {
				$str .= "<li><a class='fpage_a' href='{$this->uri}page=".($this->page-1)."'>{$this->config["prev"]}</a></li>";
				return $str;
			}
		...
		private function next(){
			if($this->page != $this->pageNum) {
				$str = "<li><a class='fpage_a' href='{$this->uri}page=".($this->page+1)."'>{$this->config["next"]}</a></li>";
				return $str;
			}
		}
		...
		private function last(){
			if($this->page != $this->pageNum) {
				$str .= "<li><a class='fpage_a' href='{$this->uri}page=".($this->pageNum)."'>{$this->config["last"]}</a></li>";
				return $str;
			}
		}
