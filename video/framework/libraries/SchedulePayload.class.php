...
class SchedulePayloadClass {
    ...
    public function createSingleSchedule($name, $push_payload, $trigger) {
        ...
        $url = SchedulePayloadClass::SCHEDULES_URL;
        return HttpClass::post($this->client, $url, $payload);
    }
    ...
    public function updateSingleSchedule($schedule_id, $name=null, $enabled=null, $push_payload=null, $trigger=null) {
        ...
        $url = SchedulePayloadClass::SCHEDULES_URL . "/" . $schedule_id;

        return HttpClass::put($this->client, $url, $payload);
    ...
    public function getSchedules($page = 1) {
        ...
        $url = SchedulePayloadClass::SCHEDULES_URL . "?page=" . $page;
        return HttpClass::get($this->client, $url);
    }
    ...
    public function deleteSchedule($schedule_id) {
        ...
        $url = SchedulePayloadClass::SCHEDULES_URL . "/" . $schedule_id;
        return HttpClass::delete($this->client, $url);
    }
}
