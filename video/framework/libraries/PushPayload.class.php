...
class PushPayloadClass {
    ...
    public function send() {
        $url = PushPayloadClass::PUSH_URL;
        return HttpClass::post($this->client, $url, $this->build());
    }

    public function validate() {
        $url = PushPayloadClass::PUSH_VALIDATE_URL;
        return HttpClass::post($this->client, $url, $this->build());
    }
    ...
    public function addIosNotification($alert=null, $sound=null, $badge=null, $content_available=null, $category=null, $extras=null) {
        ...
        if (!is_null($sound)) {
            ...
            if ($sound !== ConfigClass::DISABLE_SOUND) {
                $ios['sound'] = $sound;
            }
        } else {
            // 默认sound为''
        ...
        if (!is_null($badge)) {
            ...
            if ($badge != ConfigClass::DISABLE_BADGE) {
                $ios['badge'] = $badge;
            }
        } else {
            // 默认badge为'+1'
