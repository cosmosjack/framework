...
class DevicePayloadClass {
    ...
    public function getDevices($registrationId) {
        $url = DevicePayloadClass::DEVICE_URL . $registrationId;
    ...
    public function getTags() {
        $url = DevicePayloadClass::TAG_URL;
    ...
    public function updateTag($tag, $addDevices = null, $removeDevices = null) {
        ...
        $url = DevicePayloadClass::TAG_URL . $tag;
    ...
    public function getDevicesStatus($registrationId) {
        ...
        $url = DevicePayloadClass::DEVICE_STATUS_URL;
        return HttpClass::post($this->client, $url, $payload);
    }
}