...
class ReportPayloadClass {
    ...
    public function getReceived($msgIds) {
        ...
        $url = ReportPayloadClass::REPORT_URL . $queryParams;
    ...
    public function getMessages($msgIds) {
        ...
        $url = ReportPayloadClass::MESSAGES_URL . $queryParams;
        return HttpClass::get($this->client, $url);
    }
    ...
    public function getUsers($time_unit, $start, $duration) {
        ...
        $url = ReportPayloadClass::USERS_URL . '?time_unit=' . $time_unit . '&start=' . $start . '&duration=' . $duration;
        return HttpClass::get($this->client, $url);
    }
}
