...
define('OSS_BUILD','20180105');
define('OSS_AUTHOR', '997823131@qq.com');
...
//        die();
	...
	public function auth($options){
		...
		$msg = "---LOG START---------------------------------------------------------------------------\n";
//		echo 'ddd';
//        p($this->validate_bucket($options[self::OSS_BUCKET]));
//        p(('/' == $options[self::OSS_OBJECT]) && ('' == $options[self::OSS_BUCKET]) && ('GET' == $options[self::OSS_METHOD]));
//        die();
...
//        die();
        echo '###### sdk.class.php list_bucket_function 684 ########';
