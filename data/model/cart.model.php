...
class cartModel extends Model {
	...
	public function addCart($data = array(), $save_type = '', $quantity = null) {
        $method = '_addCart'.ucfirst($save_type); //_addCartDb
	    $insert = $this->$method($data,$quantity);  //$this->_addCartDb
	...
	private function _addCartDb($goods_info = array(),$quantity) {
    	...
    	if (empty($check_cart)){
            ...
            $update['goods_num'] = $quantity+$check_cart['goods_num'];
            $result = $this->where(array('buyer_id'=>$check_cart['buyer_id'],'goods_id'=>$check_cart['goods_id']))->update($update);
            return $result;
        }
